...
export function CareerHero() {
  return (
    <header className="relative px-[5%] md:px-[8%] pt-[100px] md:pt-[120px] pb-[40px] md:pb-[50px] overflow-visible text-[var(--text-dark)]">
      ...
      <div className="relative max-w-3xl z-[1] mx-auto text-center flex flex-col items-center">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-[2.75rem] font-extrabold mb-5 text-[var(--text-dark-strong)] leading-[1.15] tracking-tight">
          Shape the Future of <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-amber-600">Real Estate</span>
        </h1>
        
        <p className="text-[0.95rem] md:text-[1.05rem] text-[var(--text-body-muted)] leading-relaxed max-w-[600px]">
          Join a team of driven professionals passionate about transforming land investments. 
          Together, we create transparent, high-value opportunities and turn dreams into reality for thousands of investors.
        </p>
      </div>
    </header>
  );
