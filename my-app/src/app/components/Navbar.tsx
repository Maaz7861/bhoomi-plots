...
export function Navbar() {
  return (
    <nav className="navbar flex justify-between items-center px-[5%] py-4 bg-transparent fixed top-0 left-0 right-0 z-[100] max-[900px]:sticky max-[900px]:top-0 max-[900px]:z-[100] [&.nav-open_.nav-links]:max-[900px]:flex [&.nav-open_.nav-auth]:max-[900px]:flex">
      <div>
        <img
          src="assets/images/bhoomi-logo-white-1-1536x526.png"
          alt="Bhoomi Plots and Land"
          style={{ height: '50px', width: 'auto', background: '#0f172add', borderRadius: '50px', padding: '0 15px' }}
        />
      </div>
      ...
      <div className="nav-links flex gap-[30px] rounded-full px-6 py-3 bg-[var(--bg-navbar)] border border-[rgba(255,255,255,0.08)] max-[900px]:hidden max-[900px]:absolute max-[900px]:left-0 max-[900px]:top-full max-[900px]:flex-col max-[900px]:bg-[rgba(15,23,42,0.98)] max-[900px]:px-[5%] max-[900px]:py-[10px] max-[900px]:w-full max-[900px]:gap-4">
        <a href="/" className="active text-base text-[var(--primary-soft)] font-medium whitespace-nowrap border-b-2 border-[var(--primary-soft)] pb-1">Home</a>
        <a href="/about" className="text-base text-white font-medium whitespace-nowrap">About</a>
        ...
        <div className="nav-item relative group/dropdown">
          ...
          <div className="nav-dropdown absolute top-full left-0 py-[10px] rounded-lg min-w-[200px] opacity-0 pointer-events-none bg-[rgba(15,23,42,0.98)] shadow-[0_12px_30px_rgba(0,0,0,0.35)] translate-y-[6px] transition-all duration-150 ease-out group-hover/dropdown:opacity-100 group-hover/dropdown:pointer-events-auto group-hover/dropdown:translate-y-0">
            <a href="#" className="block px-4 py-2 text-[0.85rem] whitespace-nowrap text-[var(--text-soft)] hover:bg-[rgba(37,99,235,0.35)]">Sales</a>
            <a href="#" className="block px-4 py-2 text-[0.85rem] whitespace-nowrap text-[var(--text-soft)] hover:bg-[rgba(37,99,235,0.35)]">Marketing &amp; Branding</a>
            <a href="#" className="block px-4 py-2 text-[0.85rem] whitespace-nowrap text-[var(--text-soft)] hover:bg-[rgba(37,99,235,0.35)]">After Sales Services</a>
            <a href="#" className="block px-4 py-2 text-[0.85rem] whitespace-nowrap text-[var(--text-soft)] hover:bg-[rgba(37,99,235,0.35)]">Project Analysis</a>
          </div>
        </div>
