  ...
  return (
    <section className="testimonials-section relative overflow-hidden py-[clamp(48px,7vw,72px)] px-[5%] bg-[#0b1120]" aria-label="Testimonials">
      ...
      <div className="testimonials-carousel relative z-[1] flex items-center gap-4 max-w-[1200px] mx-auto max-[600px]:gap-2" aria-roledescription="carousel">
        ...
        <div className="testimonials-viewport flex-1 overflow-hidden px-1 py-4">
          <div className="testimonials-track flex gap-6 transition-transform duration-500 ease-in-out">
            {/* Video testimonials first */}
            <div className="testimonial-card flex-shrink-0 w-[calc((100%-48px)/3)] max-[900px]:w-[calc((100%-24px)/2)] max-[600px]:w-full rounded-[24px] p-6 flex flex-col gap-5 bg-[rgba(15,23,42,0.6)] border border-[rgba(0,194,255,0.15)] backdrop-blur-[12px] hover:-translate-y-2 hover:border-[rgba(0,194,255,0.4)] transition-all duration-300 hover:shadow-[0_10px_30px_rgba(0,194,255,0.1)]" data-kind="video">
